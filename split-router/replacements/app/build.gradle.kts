...
val gomobileBind by tasks.registering(Exec::class) {
    ...
    doFirst {
        ...
        check(gomobile.exists()) {
            "gomobile not found at ${gomobile.absolutePath}; run go install golang.org/x/mobile/cmd/gomobile@latest && gomobile init"
        }
...
android {
    ...
    defaultConfig {
        applicationId = "dev.shizzi.splitrouter"
        minSdk = 30
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0-xsplit"
